...
def display_obstacle(height):
    ...
    #pygame.draw.text("hello world", (20, 100))

    bottom_obstacle_height = 635 - height - 150
    bottom_obstacle_y = height + 150
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, bottom_obstacle_y, OBSTACLE_WIDTH, bottom_obstacle_height))
...
while running:
    ...
    # boundaries for the birds movement
    if bird_y <= 0:
        bird_y = 0
    if bird_y >= 571:
        bird_y = 571
